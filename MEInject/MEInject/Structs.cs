...
namespace MEInject
{
    internal enum LogLevel { Info, Warning, Error, Critical, Default }
    ...
    class MEFile
    {
        internal FptPreHeader FptPreHeader = new FptPreHeader();
        internal FptHeader FptHeader = new FptHeader();
        internal List<FptEntry> FptEntries = new List<FptEntry>();
        internal List<Mn2Manifest> Mn2Manifests = new List<Mn2Manifest>();

        // Estructuras Modernas
        internal List<CpdHeader> CpdHeaders = new List<CpdHeader>();
        internal List<CpdEntry> CpdEntries = new List<CpdEntry>();
    }

    // --- ESTRUCTURAS ANTIGUAS ($FPT) ---
